    ...
    <section class="min-w-0 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
      ...
      <div :class="cardClass">
        ...
        <ul :class="cardListClass">
          ...
          >
            ...
            <span class="ml-2 shrink-0 whitespace-nowrap text-[0.6875rem] text-[var(--vp-c-text-3)]">{{ formatDate(post.createTime ?? '') }}</span>
          </li>
      ...
      <div :class="cardClass">
        ...
        <ul :class="cardListClass">
          ...
          <li>
            <a :class="linkClass" href="https://store.steampowered.com/app/4122860" target="_blank" rel="noopener noreferrer">蘑菇的拟态日常</a>
            <span :class="[tagClass, 'ml-1.5']">漫画</span>
            <span class="mt-1 block text-xs text-[var(--vp-c-text-3)]">超现实的日常</span>
          </li>
          <li>
